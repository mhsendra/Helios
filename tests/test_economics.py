...
class TestCalculateScenario:
    ...
    def test_default_scenarios_annual_savings_are_ordered(self):
        ...
        assert (
            conservative.annual_savings
            < base.annual_savings
            < optimistic.annual_savings
        )


    def test_default_scenarios_economic_results_are_ordered(self):
        ...
        assert (
            conservative.payback_years
            > base.payback_years
            > optimistic.payback_years
        )
...
class TestEconomicsEngineAdditional:
    ...
    def test_calculate_scenario_zero_maintenance_cost(self):
        ...
        def test_scenario_annual_savings_applies_first_year_degradation(self):
        ...
        def test_scenario_first_year_cash_flow_still_includes_maintenance(self):
    ...
    def test_default_scenarios_have_different_annual_savings(self):
        ...
        conservative, base, optimistic = results
    ...
    def test_default_scenarios_have_expected_economic_order(self):
